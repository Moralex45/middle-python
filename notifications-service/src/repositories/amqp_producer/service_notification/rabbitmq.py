...
from src.models.amqp_producer import service_notification as amqp_notifications
from src.repositories.amqp_producer.service_notification.base import \
...
class AsyncRabbitMQNotificationRepository(AsyncNotificationsAMQPRepositoryProtocol):
    ...
    async def publish_notification(self, amqp_service_notification: amqp_notifications.ServiceNotification) -> None:
